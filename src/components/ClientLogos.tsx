...
const RossiCostruzioni = () => (
  <svg width="180" height="50" viewBox="0 0 180 50" fill="none" className="text-foreground">
    ...
    {/* Text */}
    <text x="40" y="26" fill="currentColor" fontSize="11" fontWeight="700" letterSpacing="0.12em" fontFamily="system-ui, sans-serif">ROSSI</text>
    ...
    <line x1="40" y1="29" x2="95" y2="29" stroke="currentColor" strokeWidth="0.4" opacity="0.5" />
  </svg>
);
...
const EdilBianchi = () => (
  <svg width="160" height="50" viewBox="0 0 160 50" fill="none" className="text-foreground">
    ...
    <text x="30" y="37" fill="currentColor" fontSize="13" fontWeight="700" letterSpacing="0.06em" fontFamily="Georgia, serif">BIANCHI</text>
  </svg>
);
...
const MuratoriUniti = () => (
  <svg width="170" height="50" viewBox="0 0 170 50" fill="none" className="text-foreground">
    ...
    <text x="40" y="37" fill="currentColor" fontSize="10" fontWeight="300" letterSpacing="0.2em" fontFamily="system-ui, sans-serif">UNITI</text>
  </svg>
);

const CostruzioniFerrari = () => (
  <svg width="190" height="50" viewBox="0 0 190 50" fill="none" className="text-foreground">
    ...
    {/* Text */}
    <text x="44" y="22" fill="currentColor" fontSize="7" fontWeight="300" letterSpacing="0.3em" fontFamily="system-ui, sans-serif">COSTRUZIONI</text>
    <text x="44" y="36" fill="currentColor" fontSize="14" fontWeight="200" letterSpacing="0.08em" fontFamily="system-ui, sans-serif">FERRARI</text>
  </svg>
);

const ImpresaColombo = () => (
  <svg width="170" height="50" viewBox="0 0 170 50" fill="none" className="text-foreground">
    ...
    <text x="40" y="35" fill="currentColor" fontSize="12" fontWeight="600" letterSpacing="0.1em" fontFamily="Georgia, serif">Colombo</text>
    <line x1="40" y1="38" x2="110" y2="38" stroke="currentColor" strokeWidth="0.3" opacity="0.4" />
  </svg>
);

const EdiliziaMoretti = () => (
  <svg width="175" height="50" viewBox="0 0 175 50" fill="none" className="text-foreground">
    ...
    <text x="36" y="38" fill="currentColor" fontSize="9" fontWeight="300" letterSpacing="0.18em" fontFamily="system-ui, sans-serif">MORETTI</text>
  </svg>
);
...
const FratelliRicci = () => (
  <svg width="165" height="50" viewBox="0 0 165 50" fill="none" className="text-foreground">
    ...
    <text x="38" y="36" fill="currentColor" fontSize="14" fontWeight="700" letterSpacing="0.06em" fontFamily="Georgia, serif">RICCI</text>
    <line x1="38" y1="24" x2="82" y2="24" stroke="currentColor" strokeWidth="0.3" opacity="0.4" />
  </svg>
);

const CantieriLombardi = () => (
  <svg width="180" height="50" viewBox="0 0 180 50" fill="none" className="text-foreground">
    ...
    {/* Text */}
    <text x="38" y="22" fill="currentColor" fontSize="7" fontWeight="300" letterSpacing="0.2em" fontFamily="system-ui, sans-serif">CANTIERI</text>
    <text x="38" y="36" fill="currentColor" fontSize="13" fontWeight="800" letterSpacing="0.04em" fontFamily="system-ui, sans-serif">LOMBARDI</text>
  </svg>
);

export const clientLogos = [
  { component: RossiCostruzioni },
  { component: EdilBianchi },
  { component: MuratoriUniti },
  { component: CostruzioniFerrari },
  { component: ImpresaColombo },
  { component: EdiliziaMoretti },
  { component: FratelliRicci },
  { component: CantieriLombardi },
];
