...
export interface CityData {
  ...
  whyDigital: string;
  /**
   * Tratto distintivo del mercato locale, in poche parole: entra nel title e
   * nella description.
   *
   * Serve a rendere ogni pagina città diversa dalle altre. Quando title e H1
   * erano identici a meno del nome della città, Google indicizzava alcune città
   * e scartava le altre come ridondanti ("scansionata, ma attualmente non
   * indicizzata" su Search Console).
   */
  focus: string;
  /** Taglio dell'H1: deve raccontare qualcosa di questo mercato, non del format. */
  h1Angle: string;
  localKeyword: string;
...
export const cities: CityData[] = [
  {
    ...
    focus: "il mercato più competitivo d'Italia",
    h1Angle: "Farsi scegliere a Milano, dove la concorrenza è massima",
  ...
  },
  {
    ...
    focus: "quadranti e clienti diffidenti",
    h1Angle: "Farsi trovare a Roma, quartiere per quartiere",
  ...
  },
  {
    ...
    focus: "ristrutturazioni e recupero ex-industriale",
    h1Angle: "Presidiare Google a Torino, dove la piazza è ancora aperta",
  ...
  },
  {
    ...
    focus: "consolidamenti e palazzi storici",
    h1Angle: "Costruire fiducia online a Napoli, prima del preventivo",
  ...
  },
  {
    ...
    focus: "efficientamento e restauro dei portici",
    h1Angle: "Convincere il cliente bolognese, che confronta e si informa",
  ...
  },
  {
    ...
    focus: "recupero e immobili vincolati",
    h1Angle: "Valorizzare le competenze di recupero a Firenze",
  ...
  },
  {
    ...
    focus: "residenziale, capannoni e lago di Garda",
    h1Angle: "Tre mercati diversi a Verona, e come presidiarli tutti",
  ...
  },
  {
    ...
    focus: "un mercato dove i concorrenti non ci sono",
    h1Angle: "Arrivare primi a Bari, finché lo spazio online è libero",
  ...
  },
  {
    ...
    focus: "centro storico, facciate e condomini",
    h1Angle: "Togliere il dubbio al cliente palermitano",
  ...
  },
  {
    ...
    focus: "cantieri difficili e lavori in quota",
    h1Angle: "Far pesare la difficoltà tecnica dei cantieri genovesi",
  ...
  },
  {
    ...
    focus: "capannoni industriali e residenziale",
    h1Angle: "Intercettare aziende e privati a Brescia",
  ...
  },
  {
    ...
    focus: "riqualificazione del costruito",
    h1Angle: "Uscire dal confronto sul prezzo a Padova",
  ...
  },
  {
    ...
    focus: "città, valli e bassa bergamasca",
    h1Angle: "Tre mercati nella stessa provincia, a Bergamo",
  ...
  },
  {
    ...
    focus: "adeguamento sismico e facciate",
    h1Angle: "Farsi trovare a Catania prima che si muovano gli altri",
  ...
  },
  {
    ...
    focus: "distretto ceramico e consolidamenti",
    h1Angle: "Distinguersi tra le imprese modenesi, tutte simili online",
  ...
  },
  {
    ...
    focus: "Costiera Amalfitana e Cilento",
    h1Angle: "Farsi trovare da chi non vive a Salerno",
