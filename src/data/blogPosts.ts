...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    faqs: [
      { q: "Cos'è la SEO locale per un'impresa edile?", a: "È il lavoro che ti fa comparire quando qualcuno cerca i tuoi servizi nella tua zona — 'impresa edile' più la città, 'rifacimento bagno' più il comune. Combina l'ottimizzazione del sito, il profilo Google My Business e le recensioni: le tre cose che Google guarda per le ricerche locali." },
      { q: "Quanto tempo serve per posizionarsi nelle ricerche locali?", a: "Nei comuni minori i primi risultati arrivano in 3-5 mesi; nei capoluoghi, dove la concorrenza è più alta, in 5-8 mesi di lavoro costante. Il profilo Google si muove molto prima, in poche settimane, ed è il punto da cui partire." },
      { q: "La SEO locale conviene più della pubblicità a pagamento?", a: "Fanno cose diverse: le campagne portano richieste subito e si fermano quando smetti di pagare; la SEO parte più lenta ma costruisce posizioni che restano, con un costo per contatto che scende nel tempo. L'ordine giusto è prima l'organico, poi le campagne come acceleratore." },
      { q: "Perché la mia impresa non compare nelle ricerche della mia città?", a: "Quasi sempre per tre motivi: il sito non ha pagine dedicate ai servizi e alle zone, il profilo Google è incompleto o senza recensioni recenti, e i dati (nome, indirizzo, telefono) sono scritti in modo diverso tra sito e profilo. Sono tutte cose che si correggono." },
    ],
  },
  {
    ...
    faqs: [
      { q: "Quali sono gli errori più comuni nella scheda Google di un'impresa edile?", a: "Categoria generica invece di quella specifica, servizi non compilati voce per voce, foto assenti o vecchie, recensioni ferme da mesi e dati diversi tra scheda e sito. Ognuno di questi tiene la scheda fuori dai tre risultati con la mappa." },
      { q: "Quante recensioni servono per entrare nel Local Pack?", a: "Non esiste una soglia: conta più la continuità del totale. Due o tre recensioni nuove al mese, chieste a fine cantiere con il link diretto su WhatsApp, battono quaranta recensioni ferme a due anni fa." },
      { q: "Ogni quanto va aggiornata la scheda Google?", a: "Un post a settimana con la foto di un cantiere e due righe è la frequenza che dà risultati: tiene la scheda attiva agli occhi di Google e mostra a chi la visita un'azienda che lavora adesso. Orari e servizi vanno aggiornati appena cambiano." },
      { q: "Posso delegare la gestione della scheda Google?", a: "Sì: la gestione continuativa di ClientiEdili costa 497€ al mese e comprende scheda Google curata, post settimanali, 12 pubblicazioni social al mese, strategia recensioni e report mensile. Tu mandi le foto dal cantiere, al resto pensiamo noi." },
    ],
  },
  {
  ...
  },
{
  ...
  faqs: [
    { q: "Come si trovano clienti per un'impresa edile nel 2026?", a: "Con un sistema a tre pezzi: un sito professionale che converte chi ti trova, la SEO locale che ti fa comparire per le ricerche della tua zona, e un profilo Google My Business curato che ti porta nei tre risultati con la mappa. Il passaparola resta, ma da solo non regola più il flusso." },
    { q: "Quanto tempo serve per vedere le prime richieste?", a: "Il sito è online in 48 ore e converte subito chi ti cerca per nome; il profilo Google si muove nel Local Pack in poche settimane; il posizionamento sulle ricerche generiche di zona richiede 3-6 mesi di lavoro costante." },
    { q: "Il passaparola non basta più?", a: "Funziona quando c'è lavoro e sparisce nei mesi lenti, cioè quando serve di più. E oggi anche chi riceve il tuo nome da un conoscente ti cerca su Google prima di chiamarti: quello che trova decide se la segnalazione diventa una telefonata." },
    { q: "Conviene comprare lead per l'edilizia?", a: "I lead comprati vengono rivenduti a più imprese contemporaneamente: arrivi su un cliente già saturo di telefonate e competi solo sul prezzo. Costruire un canale proprio è più lento ma le richieste sono esclusive e continuano ad arrivare anche quando smetti di investire." },
  ],
  },
{
  ...
  tags: ["sito-web-edile"],
  faqs: [
    { q: "Quanto costa un sito web per un'impresa edile?", a: "Con ClientiEdili il pacchetto completo costa 1.000€ una tantum invece di 1.400€: design personalizzato, copywriting, galleria lavori, ottimizzazione SEO e 30 giorni di assistenza. Zero anticipo — paghi solo dopo aver approvato il sito — con garanzia soddisfatti o rimborsati." },
    { q: "Perché i preventivi per un sito vanno da 300€ a 10.000€?", a: "Perché vendono cose diverse: a 300€ trovi un template riempito in fretta senza testi né SEO; oltre i 5.000€ paghi agenzie generaliste con costi di struttura. Il prezzo va giudicato su cosa comprende: testi scritti da chi conosce il settore, ottimizzazione locale, foto dei lavori organizzate e assistenza." },
    { q: "Ci sono costi ricorrenti dopo la realizzazione?", a: "Dominio e hosting sono gli unici costi tecnici ricorrenti, nell'ordine di poche decine di euro l'anno. Diffida di chi lega il sito a canoni mensili obbligatori 'di mantenimento': il sito deve restare tuo, con la libertà di gestirlo come vuoi." },
    { q: "Un sito economico da 300€ conviene?", a: "Quasi mai: senza testi pensati per il tuo mercato, senza ottimizzazione locale e senza una struttura che converte, il sito esiste ma non porta richieste — e dopo un anno lo rifai. Il costo vero di un sito non è quello che paghi, è il lavoro che non ti porta." },
  ],
  },
{
  ...
  },
{
  ...
  faqs: [
    { q: "Google Ads funziona per le imprese edili?", a: "Sì, ma solo con la struttura giusta: parole specifiche (servizio più zona) invece delle generiche, e pagine di atterraggio dedicate al servizio cercato invece della home. La maggior parte delle campagne edili perde soldi per questi due errori, non perché lo strumento non funzioni." },
    { q: "Quanto costa un clic per le ricerche edili?", a: "Varia molto: le parole generiche nei capoluoghi sono le più care e portano contatti poco qualificati; quelle specifiche nei comuni minori costano una frazione e convertono meglio. Il numero da guardare però non è il costo per clic ma il costo per lavoro acquisito." },
    { q: "Meglio Google Ads o la SEO per un'impresa edile?", a: "Le campagne portano richieste da subito e si fermano quando smetti di pagare; la SEO parte in mesi ma resta. L'ordine che rende: prima il sito con pagine che convertono, poi il profilo Google e l'organico, le campagne come acceleratore su periodi o servizi specifici." },
    { q: "Che budget serve per iniziare con Google Ads?", a: "Un budget che generi abbastanza richieste da valutare quante ne chiudi: con due richieste al mese non impari nulla, con quindici vedi il tasso reale. La cifra dipende dal costo per clic della tua zona — va misurato prima di partire, non dopo aver speso." },
  ],
  },
{
  ...
  },
{
  ...
  tags: ["google-my-business", "gestione-social-gmb"],
  faqs: [
    { q: "Come si chiedono le recensioni ai clienti senza risultare invadenti?", a: "A fine lavoro, quando il cliente vede il risultato ed è soddisfatto, con un messaggio WhatsApp e il link diretto alla scheda: ci mette trenta secondi. Chiedere a un cliente contento non è invadente — non chiedere significa lasciare le recensioni al caso, e per caso scrivono soprattutto gli scontenti." },
    { q: "Le recensioni contano per il posizionamento su Google?", a: "Sì, sono uno dei fattori principali del Local Pack: contano il numero, la freschezza e la continuità. Un flusso regolare di recensioni recenti segnala a Google un'azienda attiva e sposta la posizione più di quasi ogni altra cosa." },
    { q: "Come si risponde a una recensione negativa?", a: "Con calma e nel merito, senza polemiche: chi legge non giudica la critica, giudica la tua risposta. Una replica pacata che spiega come hai gestito il problema vale più di dieci recensioni entusiaste, perché mostra come ti comporti quando qualcosa va storto." },
    { q: "Si possono comprare recensioni?", a: "No, ed è la scorciatoia più pericolosa che esista: le recensioni false violano le linee guida di Google, sono sanzionabili come pratica commerciale scorretta e quando vengono rimosse in blocco la scheda crolla. Un flusso vero, anche piccolo, batte qualsiasi scorciatoia." },
  ],
  },
{
...
{
  slug: "trovare-clienti-idraulico-elettricista",
  title: "Come Trovare Clienti come Idraulico o Elettricista",
  metaTitle: "Come Trovare Clienti: Idraulico ed Elettricista",
  metaDescription: "Come trovare clienti come idraulico o elettricista: vincere le urgenze dal profilo Google e i lavori grossi — bagni, pompe di calore — con le pagine giuste.",
  date: "07 Ago 2026",
  category: "Lead Generation",
  readTime: "11 min",
  excerpt: "L'urgenza si vince sul profilo Google in cinque minuti, il bagno e la pompa di calore si vincono con le pagine giuste. Due mercati, due strategie.",
  tags: ["marketing-impiantisti", "lead-generation-edilizia"],
  faqs: [
    { q: "Come trovo clienti come idraulico o elettricista?", a: "Presidiando due mercati diversi: le urgenze, che si vincono con un profilo Google curato — categoria specifica, recensioni recenti, numero cliccabile — e i lavori programmati come bagni e pompe di calore, che si vincono con pagine dedicate che rispondono alle domande del cliente prima del sopralluogo." },
    { q: "Conta di più il profilo Google o il sito per un impiantista?", a: "Il profilo Google, ed è la leva più rapida: nell'urgenza il cliente chiama dai tre risultati con la mappa senza aprire nessun sito. Il sito serve per i lavori programmati, dove il cliente si informa prima di decidere. Si parte dal profilo e si costruisce il sito subito dopo." },
    { q: "Vale la pena scrivere contenuti sulle pompe di calore?", a: "È l'opportunità più grande del momento: la transizione dalle caldaie sposta moltissimo lavoro e il cliente ne sa pochissimo, quindi cerca tanto. Le risposte scritte da tecnici veri sono rarissime: chi le pubblica si prende il traffico e i sopralluoghi che ne derivano." },
    { q: "Come ottengo più chiamate per le urgenze?", a: "Con un profilo Google completo — categoria specifica, orari veri comprese le reperibilità, zone realistiche, foto dei lavori — e recensioni chieste sistematicamente a fine intervento. Nell'urgenza il cliente non scorre oltre i primi tre risultati: tutto il lavoro si concentra lì." },
    { q: "Gli amministratori di condominio come si conquistano?", a: "Con una sezione dedicata che mostra ciò che guardano loro: manutenzioni gestite, tempi di intervento medi, ordine nella fatturazione. Un amministratore soddisfatto vale decine di clienti privati, tra manutenzioni programmate e segnalazioni ai condòmini." },
  ],
},
{
  slug: "trovare-clienti-ristrutturazioni",
  title: "Come Trovare Clienti per le Ristrutturazioni (senza fare il prezzo più basso)",
  metaTitle: "Come Trovare Clienti per le Ristrutturazioni",
  metaDescription: "Come trovare clienti per le ristrutturazioni senza vincere solo sul prezzo: cosa guarda chi deve ristrutturare e come arrivare al sopralluogo in vantaggio.",
  date: "11 Ago 2026",
  category: "Lead Generation",
  readTime: "11 min",
  excerpt: "Chi ristruttura non sceglie il preventivo più basso: sceglie quello che gli fa meno paura. Ecco come dimostrare online le tre cose che spostano la scelta.",
  tags: ["marketing-ristrutturazioni", "lead-generation-edilizia"],
  faqs: [
    { q: "Come trovo clienti per la mia impresa di ristrutturazioni?", a: "Dimostrando online, prima del sopralluogo, le tre cose che il committente verifica sempre: cantieri conclusi raccontati per intero, tempi dichiarati e recensioni recenti. Il cliente chiede tre preventivi ma arriva al primo contatto con una classifica già in testa, costruita su quello che ha trovato." },
    { q: "Perché il preventivo più basso spesso non vince?", a: "Perché chi ristruttura sta affidando a sconosciuti decine di migliaia di euro e la casa in cui vive: non sceglie il prezzo più basso, sceglie l'impresa che gli fa meno paura. Un prezzo stracciato spesso insospettisce. Si vince riducendo il rischio percepito, non la cifra." },
    { q: "Conviene specializzarsi o restare generalisti?", a: "Specializzarsi nella comunicazione: presidiare le ricerche specifiche — rifacimento bagno, chiavi in mano, cucine, uffici — con pagine dedicate, invece della generica \"impresa ristrutturazioni\" contesa da tutti. Meno volume ma intenzione più alta, meno concorrenza e margine difendibile." },
    { q: "Devo mostrare i prezzi delle ristrutturazioni sul sito?", a: "Gli ordini di grandezza sì, con quello che comprendono e cosa fa variare il prezzo. \"Quanto costa ristrutturare un bagno\" è tra le ricerche più fatte del settore: chi risponde onestamente si prende il traffico e la fiducia, e riceve richieste più qualificate." },
    { q: "Qual è la singola cosa che aumenta di più i lavori chiusi?", a: "La velocità di risposta. Chi manda una richiesta ne manda in genere tre: richiamare entro un'ora comunica esattamente l'affidabilità che il cliente cerca, richiamare dopo due giorni significa trovare uno che ha già fissato due sopralluoghi altrove." },
  ],
},
{
  slug: "come-aziende-scelgono-impresa-capannone",
  title: "Come le Aziende Scelgono l'Impresa per il Capannone",
  metaTitle: "Come le Aziende Scelgono chi Costruisce il Capannone",
  metaDescription: "Come un'azienda sceglie l'impresa per costruire o ristrutturare il capannone: chi decide, cosa verifica online e come entrare nella lista corta.",
  date: "14 Ago 2026",
  category: "Lead Generation",
  readTime: "10 min",
  excerpt: "La prima scrematura avviene online, prima di qualsiasi contatto: chi non mostra opere, metrature e certificazioni viene escluso senza saperlo.",
  tags: ["marketing-edilizia-industriale", "lead-generation-edilizia"],
  faqs: [
    { q: "Come sceglie un'azienda l'impresa per il proprio capannone?", a: "Con una lista corta costruita online prima di qualsiasi contatto: il titolare o il responsabile tecnico cerca chi ha già realizzato opere simili, di quella dimensione, in quel settore. Chi non mostra nulla viene escluso senza saperlo — nessuno chiama per dire che sei stato scartato." },
    { q: "Cosa deve mostrare il sito di un'impresa di edilizia industriale?", a: "Dati verificabili con linguaggio tecnico asciutto: schede opera con metrature, tempi e settore del committente, dimensione delle commesse gestite, certificazioni e attestazioni SOA, solidità dell'azienda. Il committente tecnico si fida dei numeri, non degli slogan." },
    { q: "Le ricerche industriali sono poche: vale la pena presidiarle?", a: "Sì, perché il valore per ricerca ribalta il conto: una singola commessa intercettata — un capannone, una copertura, una bonifica — vale quanto un anno di lavori residenziali. E la concorrenza online quasi assente rende il posizionamento rapido e stabile." },
    { q: "Perché amianto e fotovoltaico insieme sono l'opportunità migliore?", a: "Perché migliaia di capannoni hanno coperture in cemento-amianto da sostituire per obbligo, e la sostituzione è il momento naturale per installare il fotovoltaico sulla nuova copertura: il costo diventa un investimento che si ripaga. Quasi nessuna impresa presidia queste ricerche con una pagina dedicata." },
    { q: "Se lavoro già su relazioni consolidate, il sito serve?", a: "Sì, per due motivi: le relazioni concentrano il rischio su pochi nomi e non portano committenti nuovi; e chi riceve il tuo nome da uno studio tecnico ti cerca comunque online — quello che trova decide quanto peso dare alla segnalazione." },
  ],
},
];
